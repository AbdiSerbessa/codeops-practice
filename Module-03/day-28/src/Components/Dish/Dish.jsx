...
import DishImage from './DishImage'; // Import the new image component
import './Dish.css';
...
export default function Dish({ name, price, currency = 'ETB', spicy, imageUrl, onAddToCart }) {
  ...
  return (
    <div className="dish-card">
      <DishImage url={imageUrl} altText={name} /> {/* Render the image */}
...
Dish.propTypes = {
  ...
  imageUrl: PropTypes.string.isRequired, // Define new required prop
